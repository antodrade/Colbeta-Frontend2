...
// import { PdfScannerService } from 'src/app/servicios/pdf-scanner.service';
...
export class NuevoUsuarioComponent implements OnInit {
 ...
 // empresas: Empresa[] = [];
  ...
  // Agregar el método para capturar la selección del archivo
  ...
  //       const urlFirma = this.formulario.usuario.urlFirma;
        
  //       const firmaFile = await this.urlToFile(urlFirma, 'firma1.png');
  //       const firmaFile2 = firmaFile;
